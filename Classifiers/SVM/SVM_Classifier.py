...
def SVM_Classifier(time_freq):
    ...
    clf = svm.SVC(kernel='poly', degree=5, C=1, gamma='scale')
...
if __name__ == '__main__':
    ...
    SVM_Classifier(time_freq='25S')
    SVM_Classifier(time_freq='15S')
    SVM_Classifier(time_freq='5S')
